...
public class SecurityConfig {
    ...
    private static final String[] PUBLIC_RESOURCES = {"/test", "/swagger-ui/**", "/.well-known/**, ", "/v3/api-docs/**"};
    private static final String[] USER_RESOURCES = {"/user/**"};
    private static final String[] ADMIN_RESOURCES = {"/admin/**"};
    private static final String LOGIN_RESOURCE = "/login";
    private static final String ROLE_ADMIN = "write";
    private static final String APPLICATION_OWNER = "Weizman";
}
